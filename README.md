...
- Topic candidates могут хранить русские display-заголовки и пояснения (`title_ru`, `reason_ru`) для админского интерфейса; оригинальный заголовок источника и URL сохраняются для проверки
- Если русский display-заголовок недоступен или перевод не настроен/не сработал, бот показывает исходный заголовок без ошибки
